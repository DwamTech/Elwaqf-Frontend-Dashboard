...
import { FiSave, FiImage, FiUser, FiCalendar, FiTag, FiLayers, FiFileText, FiPlus } from "react-icons/fi";
    ...
    return (
        <div className="w-full max-w-6xl mx-auto space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">تعديل المقال</h1>
                    <p className="text-gray-500 text-sm mt-1">قم بتعديل البيانات التالية لتحديث المقال</p>
                </div>
